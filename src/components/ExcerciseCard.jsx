  ...
  return (
    <div className='p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap'>
        ...
        <div className='flex flex-col sm:flex-row sm:items-center sm:flex-wrap gap-x-4'>
            ...
            <h2 className='capitalize whitesapce-nowrap truncate max-w-full text-lg sm:text-xl md:text-2xl flex-1 sm:text-center'>
        ...
        <button onClick={handleSetIncrement} className='flex flex-col p-2 rounded border-[1.5px] duration-200 border-solid border-orange-800 hover:border-orange-600 w-full duration-200'>
